...
## Build Output ##
Copy the following files/folders as directed to re-create the SDK structure:
*All files are relative to the build folder generated by cmake, which is specified by the user with the -B parameter*

|Repository|Source|Destination|
|----|----|----|
|Vulkan-LoaderAndValidationLayers|libVulkan.so|lib/|
